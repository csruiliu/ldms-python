...
metrics_descriptions = {
    ...
    "cpu_vmstat_io_bi": "Blocks received from a block device per sec (KB/s)",
    "cpu_vmstat_io_bo": "Blocks sent to a block device per sec (KB/s)",
    "cpu_vmstat_mem_buff": "Total memory temporarily used as a data buffer (GB)",
    "cpu_vmstat_mem_cache": "Total cache memory (GB)",
    ...
    "cpu_vmstat_system_cs": "Number of context switches per sec",
    "cpu_vmstat_system_in": "Number of system interrupts per sec",
    "gpu_dcgm_correctable_remapped_rows": "Number of remapped rows for correctable errors",
    ...
    "gpu_dcgm_ecc_dbe_aggregate_total": "Total number of double-bit persistent ECC errors",
    "gpu_dcgm_ecc_dbe_volatile_total": "Total number of double-bit volatile ECC errors",
    "gpu_dcgm_ecc_sbe_aggregate_total": "Total number of single-bit persistent ECC errors",
    "gpu_dcgm_ecc_sbe_volatile_total": "Total number of single-bit volatile ECC errors",
    ...
    "gpu_dcgm_nvlink_bandwidth_total": "Total number of NVLink bandwidth counters for all lanes",
    "gpu_dcgm_nvlink_data_crc_error_count_total": "Total number of NVLink data CRC errors",
    "gpu_dcgm_nvlink_flit_crc_error_count_total": "Total number of NVLink flow-control CRC errors",
    "gpu_dcgm_nvlink_recovery_error_count_total": "Total number of NVLink recovery errors",
    "gpu_dcgm_nvlink_replay_error_count_total": "Total number of NVLink retries.",
    "gpu_dcgm_pcie_replay_counter": "GPU total number of PCIe retries",
    "gpu_dcgm_pcie_rx_throughput": "GPU total number of bytes received through PCIe RX via NVML (KB)",
    "gpu_dcgm_pcie_tx_throughput": "GPU total number of bytes transmitted through PCIe TX via NVML (KB)",
    ...
    "gpu_dcgm_sm_occupancy": "Ratio of number of warps resident on an SM (%)",
    ...
    "gpu_dcgm_uncorrectable_remapped_rows": "Number of remapped rows for uncorrectable errors",
